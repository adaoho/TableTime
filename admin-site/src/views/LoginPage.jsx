...
const LoginPage = () => {
  ...
  const getLogin = async (element) => {
    element.preventDefault();
    try {
      const { data } = await tableTimeApi.post("/user/login", loginForm);
    ...
    <>
      ...
      >
        <div className="w-full max-w-md p-8 space-y-3 rounded-xl text-gray-100 shadow-2xl bg-white">
          ...
          <form action="" className="space-y-6" onSubmit={getLogin}>
          ...
          <div className="flex justify-center space-x-4">
            <button
              ...
              className="p-3 text-gray-500 rounded-sm hover:text-red-500 hover:scale-105"
            >
              <svg
          ...
          {/* <p className="text-xs text-center sm:px-6 dark:text-gray-400">
            ...
            <Link
              ...
              className="underline text-gray-800 hover:scale-105 hover:text-red-500 hover:font-bold"
            >
              Sign up
            </Link>
          </p> */}
